...
parser.add_argument(
    ...
    type=int, default=1, help="number of postprocessing blocks",
)
parser.add_argument(
...
parser.add_argument("--time_epochs", type=bool, default=True, help="time each training epoch")
